...
const JNINativeMethod method_decoder_table[] = {
  ...
  { "nativeWriteDecoder", "(ILjava/nio/ByteBuffer;I)I", (void *) nativeWriteDecoder },
  { "nativeDecoderGetExpectedLength", "(I)I", (void *) nativeDecoderGetExpectedLength },
  { "nativeDecoderFlush", "(I)V", (void *) nativeDecoderFlush }
};
...
const JNINativeMethod method_encoder_table[] = {
  ...
  { "nativeWriteEncoder", "(ILjava/nio/ByteBuffer;I)I", (void*) nativeWriteEncoder },
  { "nativeEncoderFlush", "(I)V", (void *) nativeEncoderFlush }
};
